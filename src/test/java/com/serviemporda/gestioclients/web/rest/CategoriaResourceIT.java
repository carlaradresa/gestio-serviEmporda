...
public class CategoriaResourceIT {
    ...
    private static final String UPDATED_NOM_CATEGORIA = "BBBBBBBBBB";
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria()
            .nomCategoria(DEFAULT_NOM_CATEGORIA);
        return categoria;
    }
    /**
    ...
    public void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.getNomCategoria()).isEqualTo(DEFAULT_NOM_CATEGORIA);
    }
    ...
    public void updateCategoria() throws Exception {
        ...
        Categoria testCategoria = categoriaList.get(categoriaList.size() - 1);
        assertThat(testCategoria.getNomCategoria()).isEqualTo(UPDATED_NOM_CATEGORIA);
    }
